...
<script>
    ...
    const screenWidth =window.screen.width * window.devicePixelRatio;//window.innerWidth;
    const screenHeight = window.screen.height * window.devicePixelRatio;//window.innerHeight;
